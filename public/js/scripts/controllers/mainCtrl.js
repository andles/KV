...
app.controller('mainCtrl', function($scope, $location){
	...
	// 	var mapOptions = {	
	// 		zoom: 15,
	// 		center: new google.maps.LatLng(37.1115275, -113.5202898),
...
$scope.map = { center: { latitude: 37.111527, longitude: -113.5202898 }, zoom: 13 };
$scope.options = {scrollwheel: false, mapTypeControl: true, coords: { latitude: 37.111527, longitude: -113.5202898 }};
